...
import { BellOff, Headset, X } from "lucide-react";
  ...
  return (
    <div className="h-[min(85vh,820px)] overflow-hidden">
      <div className="pt-5 px-7 bg-dark-secondary h-[96px]">
        <DialogHeader className="mb-1 text-left text-[20px] flex-row items-center justify-between text-text-primary font-[600]">
